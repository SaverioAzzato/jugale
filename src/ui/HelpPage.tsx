...
const CONTENT: Record<Locale, HelpContent> = {
  ...
  it: {
    ...
    miscItems: [
      ...
      "La schermata iniziale tiene un elenco Recenti per riaprire un personaggio con un clic. Dove la piattaforma può mantenere un collegamento vivo al file (desktop e browser Chromium) lo riapre in scrittura; sui browser che non possono (Firefox, Safari) salva uno snapshot in sola lettura, così il personaggio compare comunque — basta esportare per salvare. È tutto locale: sul dispositivo resta solo un riferimento (o quello snapshot), mai inviato da nessuna parte. Puoi svuotarlo quando vuoi con Svuota; una voce che non si apre più (file spostato o eliminato) viene rimossa in automatico.",
