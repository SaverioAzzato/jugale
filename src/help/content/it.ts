    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          intro: "Per inviare subito il materiale, premi Condividi e scegli il chatbot. In alternativa puoi usare Scarica come descritto sotto: è disponibile anche su Android. Quando il chatbot ha terminato, scarica il character.json completo. Da File o Download, condividi quel file e scegli JUGALE oppure JUGALE Dev. JUGALE mostra sempre un'anteprima prima di modificare qualcosa.",
        ...
        {
          title: "Scarica un unico file su qualsiasi dispositivo",
          intro: "Scarica è disponibile su web, desktop e Android. Usalo quando vuoi allegare al chatbot un solo file invece di condividere direttamente dall'app.",
          steps: ["Apri Prompt e scegli il tipo di lavoro.", "Premi Scarica accanto al prompt. JUGALE salva un file di testo con il prompt e lo Schema JSON corrente.", "Se hai un personaggio aperto, il file include anche il suo character.json completo. Per Migra include inoltre il changelog dello schema.", "Allega il file di testo alla conversazione con il chatbot.", "Salva la risposta finale come character.json, poi importala come descritto sotto."],
          bullets: ["Puoi usare Scarica anche senza aprire un personaggio: il file conterrà comunque prompt e schema, ma non character.json."],
        },
        {
          title: "Importa il personaggio restituito",
          intro: "Usa Importa JSON personaggio nella barra in alto su web, desktop o Android. JUGALE mostra un'anteprima del file scelto prima di salvare o sostituire qualcosa.",
          steps: ["Salva la risposta completa del chatbot come file .json.", "Premi Importa JSON personaggio e scegli quel file.", "Controlla nell'anteprima nome del personaggio, versione dello schema, errori e avvisi.", "Se hai un personaggio aperto, premi Applica per sostituire il suo character.json. Le immagini restano al loro posto; quando lo storico versioni è attivo, JUGALE salva prima il personaggio corrente in Versioni.", "Se non hai un personaggio aperto, premi Scegli cartella personaggio e seleziona una cartella davvero vuota. JUGALE crea character.json lì solo dopo la conferma."],
          bullets: ["Applica e Crea restano disattivati finché il JSON scelto non è valido e supportato da questa versione di JUGALE.", "Creare una cartella personaggio abilita subito immagini della cartella e Versioni. Una cartella non vuota senza character.json viene rifiutata.", "La creazione di cartelle scrivibili è disponibile sui browser basati su Chromium, desktop e Android; gli altri browser spiegano la limitazione."],
        },
      ],
    },
    {
