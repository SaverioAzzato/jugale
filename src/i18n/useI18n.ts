...
const en = {
  ...
  "prompts.intro": "Copy one of these into any chatbot (ChatGPT, Claude, etc.) to build, level up, or validate a character against this app's character.json contract. Prompts are kept in English so they work with any chatbot regardless of your interface language.",
  "prompts.base": "Base",
...
const it: Record<StringKey, string> = {
  ...
  "prompts.intro": "Copia uno di questi in un chatbot qualsiasi (ChatGPT, Claude, ecc.) per costruire, far salire di livello o validare un personaggio secondo il contratto character.json di questa app. I prompt restano in inglese così funzionano con qualsiasi chatbot indipendentemente dalla lingua dell'interfaccia.",
  "prompts.base": "Base",
